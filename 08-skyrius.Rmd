...
```{r z-times-z-grandine, echo=FALSE, fig.cap="Loginė grandinė, realizuojanti $\\mathrm{e}^{\\mathrm{i}\\theta Z_1\\otimes Z_2}$ operatorių tarp dviejų kubitų. Ancila kubitui pritaikomi $R_z$ posūkio loginiai vartai.", out.width='80%', fig.align='center'}
knitr::include_graphics("media/image8_1.svg")
```

\@ref(fig:z-times-z-grandine) pav. parodyta kvantinė grandinė,
...
```{r potencines-energijos-grandine, echo=FALSE, fig.cap="Loginė grandinė, atliekanti potencinės energijos funkcijos $V(x)$ su trimis barjerais veiksmą banginei funkcijai $\\psi(x)$ viename laiko intervale.", out.width='80%', fig.align='center'}
...
```{r gauso-diskretizuota-funkcija, echo=FALSE, fig.cap="Gauso formos diskretizuota banginė funkcija, perteikta 16-os taškų gardelėje.", out.width='80%', fig.align='center'}
...
```{r klasikinio-ml-metodai, echo=FALSE, fig.cap="Klasikinio mašininio mokymosi metodai.", out.width='80%', fig.align='center'}
...
```{r kvantiniu-grandiniu-klasifikatorius, echo=FALSE, fig.cap="Kvantinėmis grandinėmis paremtas klasifikatorius. Loginių operacijų grandinė $A$ atlieka pradinės būsenos paruošimą; ji yra toliau apdorojama modelio $U(\\theta)$ grandinėje optimizuojant klasifikatorių. Galiausiai, atliekama binarinė klasifikacija išmatuojant pirmojo kubito būseną.", out.width='80%', fig.align='center'}
...
```{r hibridinis-ml-algoritmas, echo=FALSE, fig.cap="Hibridinis kvantinis-klasikinis mokymo algoritmas. Kvantinis įrenginys yra naudojamas išvesties ir gradientų suskaičiavimui; kvantinės grandinės parametrai $\\theta$ atnaujinami naudojantis klasikiniu algoritmu.", out.width='80%', fig.align='center'}
