...
### Aizingo modelis ir hamiltoniano kodavimas {#ising-hamiltonian-coding}
...
suformuoti unitarųjį operatorių $U$ imdami jo ekponentę
$\mathrm{e}^{\mathrm{i}At}$, ir šį
...
\@ref(ising-hamiltonian-coding) skyriuje. Operatoriaus $U$ tikrines vertes $\mathrm{e}^{\mathrm{i}\lambda_k t}$ randamos
