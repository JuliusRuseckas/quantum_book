...
kvantinę sistemą pozicijos intervale.
...
```{r triju-kubitu-blokas, echo=FALSE, fig.cap="3 kubitų kvantinį supynimą sudarančios grandinės blokas. $G_j$ yra 1 kubito loginiai vartai", out.width='80%', fig.align='center'}
...
\@ref(ising-hamiltonian-coding) skyriuje. Operatoriaus $U$ tikrines vertes $\mathrm{e}^{\mathrm{i}\lambda_k t}$ galima nustatyti
...
\end{equation}
kur $\mathrm{Tr}_P$ -- dalinis pėdsakas per pirmą kintamąjį, o $W$ -- SWAP
