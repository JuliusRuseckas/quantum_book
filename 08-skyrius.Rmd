...
Vietoj šio matavimo galima apskaičiuoti globalius banginės funkcijos
...
(eq:a-kaip-unitarusis-op) lygtimi. Operatoriaus $U$ tikrines vertes $\mathrm{e}^{\mathrm{i}\lambda_k t}$ randamos
panaudojant kvantinį fazės nustatymo algoritmą,
aprašytą \@ref(kvantinis-fazes-nustatymas) poskyryje.

Šiuose alogritmuose reikia apskaičiuoti matricos $\rho$ eksponentę. Šį skaičiavimą paspartina
