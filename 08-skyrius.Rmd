...
(elektronai, protonai, neutronai), turinčios $1/2$ **sūkį** (angl. *$1/2$ spin*).
...
fenomenų gausa. Pavyzdžiui, taip vadinamas laiko kristalas (angl. *time crystal*) buvo realizuotas kvantiniuose kompiuteriuose naudojant Aizingo modelį su periodinėmis išorinio lauko perturbacijomis ir lokaliomis netvarkos dedamosiomis. 2 dimensijose šis modelis leidžia apibūdinti feroelektrinį tvarkos-netvarkos fazinį virsmą (angl. *ferroelectric order-disorder phase transition*).
