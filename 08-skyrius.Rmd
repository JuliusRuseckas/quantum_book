...
\@ref(fig:z-times-z-grandine) pav. parodyta grandinė,
realizuojanti $\mathrm{e}^{\mathrm{i}\theta Z_k\otimes Z_l}$ operatorių kubitams
$k_1$ ir $k_2$ pasitelkiant ancilą $a_1$.

```{r z-times-z-grandine, echo=FALSE, fig.cap="Loginė grandinė, realizuojanti $\\mathrm{e}^{\\mathrm{i}\\theta Z_1\\otimes Z_2}$ operatorių tarp dviejų kubitų. Ancila kubitui pritaikomi $R_z$ posūkio loginiai vartai", out.width='52%', fig.align='center'}
