...
```{r 3-kubitu-ft-grandine, echo=FALSE, fig.cap="3 kubitų registrui kvantinę Furjė transformaciją atliekanti loginė grandinė.", out.width='80%', fig.align='center'}
knitr::include_graphics("media/image7_1.png")
```
...
```{r atvirkstine-3-kubitu-ft, echo=FALSE, fig.cap="Atvirkštinė 3 kubitų kvantinė Furjė transformacija.", out.width='80%', fig.align='center'}
knitr::include_graphics("media/image7_2.png")
```
...
```{r kvantine-ft-grandine-n-kubitu, echo=FALSE, fig.cap="Loginė grandinė, atliekanti kvantinę Furjė transformaciją $n$ kubitų registrui.", out.width='80%', fig.align='center'}
knitr::include_graphics("media/image7_3.png")
```

Furjė transformacija, atliekama $n$-kubitų registrui,
paremta \@ref(fig:atvirkstine-3-kubitu-ft) pav. jau
...
```{r periodiskuma-nustatanti-grandine, echo=FALSE, fig.cap="Funkcijos periodiškumą nustatanti loginė grandinė. Furjė transformacija $n$ kubitų registrui glaustai užrašyta kaip modulis FT.", out.width='80%', fig.align='center'}
knitr::include_graphics("media/image7_4.png")
```
...
```{r grandine-fazes-nustatymui, echo=FALSE, fig.cap="Bendra loginė grandinė, realizuojanti fazės nustatymo algoritmą.", out.width='80%', fig.align='center'}
knitr::include_graphics("media/image7_5.png")
```
...
knitr::include_graphics("media/image7_6.png")
```
