...
metodą** (angl. *conjugate gradient method*). HHL algoritmas yra aptinkamas kaip modulis kituose
kvantiniuose algoritmuose, įskaitant mašininio mokymosi. 
Apžvelgsime šio algoritmo bendruosius veikimo principus ir
...
sunkiau invertuoti matricą $A$ ir mažėja HHL algoritmo
