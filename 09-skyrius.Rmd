...
```{r grandine-shoro-loginiam-kubitui, echo=FALSE, fig.cap="Loginė grandinė, paruošianti Šoro 9 kubitų kodo loginį kubitą", out.width='58%', fig.align='center'}
...
```{r klaidoms-atsparus-loginiai-elementai, echo=FALSE, fig.cap="Loginė grandinė, dviem 3 kubitų kodo loginiams kubitams atliekanti klaidoms atsparius Hadamardo ir sąlyginius $cX$ loginius vartus", out.width='73%', fig.align='center'}
