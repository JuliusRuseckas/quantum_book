...
```{r grandine-loginio-paruosimui, echo=FALSE, fig.cap="Loginė grandinė, paruošianti loginį kubitą, skirtą taisyti fazės klaidai.", out.width='80%', fig.align='center'}
...
```{r grandine-shoro-loginiam-kubitui, echo=FALSE, fig.cap="Loginė grandinė, paruošianti Šoro 9 kubitų kodo loginį kubitą.", out.width='80%', fig.align='center'}
...
\begin{align}
X_1\otimes X_2\otimes X_3\big(|000\rangle + |111\rangle\big ) = & |000\rangle + |111\rangle = |+\rangle\,;(\#eq:bloko-buena-p1)\\
X_1\otimes X_2\otimes X_3\big(|000\rangle - |111\rangle\big ) = & -\big(|000\rangle - |111\rangle) = - |-\rangle\,.(\#eq:bloko-buena-m1)
\end{align}
