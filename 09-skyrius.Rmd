...
\end{align}
Hadamardo testo kvantinė grandinė (žr. \@ref(hadamard-testas-poskyris) poskyrį) su
...
```{r klaidoms-neatspari-grandine, echo=FALSE, fig.cap="Klaidoms neatspari loginė grandinė, atliekanti kubitų supynimą ir jų matavimą.", out.width='80%', fig.align='center'}
knitr::include_graphics("media/image9_6.svg")
```

```{r klaidoms-atsparus-loginiai-elementai, echo=FALSE, fig.cap="Loginė grandinė, dviem 3 kubitų kodo loginiams kubitams atliekanti klaidoms atsparius Hadamardo ir sąlyginius $cX$ loginius vartus.", out.width='80%', fig.align='center'}
...
```{r klaidoms-atspari-versija, echo=FALSE, fig.cap="Iliustracijoje \\@ref(fig:klaidoms-neatspari-grandine) pav. parodytos loginės grandinės klaidoms atspari versija. Du loginiai kubitai čia bendrai koduojami $n$ kubitais, toliau patikrinama, ar koduojant neįvyko klaidų, ir atitinkamai atliekamas taisymas.  Pirmam loginiam kubitui pritaikomi klaidoms atsparūs $H$; matomi dar du periodiniai klaidų nustatymai ir 2 loginių kubitų klaidoms atsparūs $cX$; galiausiai atliekami klaidoms atsparūs kubitų būsenos matavimai.", out.width='100%', fig.align='center'}
...
(žr. \@ref(kodu-stabilizatoriai-poskyris) poskyrį), kuris čia pritaikomas 3 kubitų būsenos
...
+1 ir -1 poerdvius. Tai atliekanti kvantinė grandinė
...
```{r klaidoms-atsparus-matavimai, echo=FALSE, fig.cap="Klaidoms atsparūs 3 kubitų loginio kubito būsenos $|psi\\rangle$ bendrojo tipo matavimai.", out.width='80%', fig.align='center'}
...
```{r kodu-konkatenacijos-schema, echo=FALSE, fig.cap="Kodų konkatenacijos schema. Nurodytos nepataisomos klaidos tikimybė kiekviename kodavimo lygyje.", out.width='80%', fig.align='center'}
...
```{r kvantinio-turio-protokolo-grandine, echo=FALSE, fig.cap="Kvadratinėmis $(d \\times d)$ grandinėmis pagrįstas kvantinio tūrio nustatymo protokolas.", out.width='80%', fig.align='center'}
...
schemas. Pirmoje (\@ref(fig:dvi-kv-procesoriaus-architekturos) pav., a)
pavaizduota IBM superlaidininkais
...
Antroji (\@ref(fig:dvi-kv-procesoriaus-architekturos) pav., b)
pateikta kvantinio procesoriaus architektūra
...
```{r dvi-kv-procesoriaus-architekturos, echo=FALSE, fig.cap="Dvi kvantinio procesoriaus architektūros, pasitelkiančios skirtingą kubitų tarpusavio jungimą. Tai nulemia, tarp kurių kubitų galima atlikti 2 ar daugiau kubitų sąlyginius loginius vartus.", out.width='45%', fig.align='center', fig.show='hold'}
