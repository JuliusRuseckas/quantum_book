...
```{r klaidoms-atsparus-loginiai-elementai, echo=FALSE, fig.cap="Kvantinė grandinė, dviem 3 kubitų kodo loginiams kubitams atliekanti klaidoms atsparius Hadamardo $\overline{H}$ ir sąlyginius $\overline{cX}$ loginius vartus", out.width='73%', fig.align='center'}
...
(žr. \@ref(hadamardo-testas-poskyris) poskyrį), kuris čia pritaikomas 3 kubitų būsenos
