...
```{r klaidoms-atsparus-loginiai-elementai, echo=FALSE, fig.cap="Kvantinė grandinė, dviem 3 kubitų kodo loginiams kubitams atliekanti klaidoms atsparius loginius vartus", out.width='73%', fig.align='center'}
