...
```{r kvantine-grandine, echo=FALSE, fig.cap="Kvantinės grandinės pavyzdys", out.width='80%', fig.align='center'}
...
```{r kvantinio-skaiciavimo-procesas, echo=FALSE, fig.cap="Kvantinio skaičiavimo procesas", out.width='70%', fig.align='center'}
