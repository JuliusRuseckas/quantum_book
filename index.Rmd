...
vieną dokumentą asmeniniams tolimesniems darbams. Perorientuoti dokumentą į
...
taip pat naudota iš Tado Paulausko doktorantūros metu klausyto kurso „Quantum
computing“, kurį dėstė profesorius Friedland Shmuel, užrašų. 

Išleisdami atvirai prieinamą internetinę knygą norime paskatinti kitus tyrėjus
prisijungti ją gerinant ir papildant naujais skyriais.
...
Autoriai dėkoja Vaidui Pačebutui ir Arūnui Krotkui už paramą bei palaikymą
rengiant šią knygą, taip pat Audriui Alkauskui, Maženai Mackoit Sinkevičienei,
...
Visą knygos turinį bookdown formate galite pasiekti [GitHub paskyroje](https://github.com/JuliusRuseckas/quantum_book). 
