...
(žr. 5.1 pav.) Agnė turi kubitą $k_1$ būsenoje
$|\psi\rangle = a|0\rangle + b|1\rangle$,
...
\begin{align}
|k_1 k_2\rangle = & |00\rangle\rightarrow |k_3 \rangle = a|0\rangle + b|1\rangle\,; \\
|k_1 k_2\rangle = & |10\rangle\rightarrow |k_3 \rangle = a|0\rangle - b|1\rangle\,; \\
|k_1 k_2\rangle = & |01\rangle\rightarrow |k_3 \rangle = b|0\rangle + a|1\rangle\,; \\
|k_1 k_2\rangle = & |11\rangle\rightarrow |k_3\rangle = - b|0\rangle + a|1\rangle\,.
\end{align}
...
**5.2 pav.** Loginė grandinė, realizuojanti kvantinę teleportaciją.
Paskutiniame žingsnyje kubitui $k_3$ pritaikomi sąlyginiai Pauli loginiai vartai,
kontroliuojami klasikinio registro, kurio būseną nulemia pirmų dviejų kubitų matavimo rezultatai

Teleportaciją galime atlikti ir
kvantiniame procesoriuje tarp kubitų. Vienas būdas tai užrašyti
loginiais vartais yra parodytas 5.2 pav. Matome Agnės kubitą $k_1$
...
Supintosios Belo būsenos kubitų porose $(k_1 , k_2)$ ir $(k_3 , k_4)$
yra panaudojamos sukurti Belo būsenai tarp potencialiai nutolusių kubitų
$(k_1 , k_4)$ pasitelkiant tarpinį kubitų $(k_2 , k_3 )$ Belo matavimą
...
sukeitimą (žr. 5.3 pav.). Tai leidžia efektyviai padidinti kvantinio
...
\begin{align}
|k_2 k_3 \rangle = & |00\rangle\rightarrow |k_1 k_4 \rangle = \frac{1}{\sqrt{2}}\big(|00\rangle + |11\rangle\big) = |\chi^{+}\rangle\,;\\
|k_2 k_3 \rangle = & |01\rangle\rightarrow |k_1 k_4 \rangle = \frac{1}{\sqrt{2}}\big(|01\rangle + |10\rangle\big) = |\eta^{+}\rangle\,;\\
|k_2 k_3 \rangle = & |10\rangle\rightarrow |k_1 k_4 \rangle = \frac{1}{\sqrt{2}}\big(|00\rangle - |11\rangle\big) = |\chi^{-}\rangle\,;\\
|k_2 k_3 \rangle = & |11\rangle\rightarrow |k_1 k_4 \rangle = \frac{1}{\sqrt{2}}\big(|01\rangle - |10\rangle\big) = |\eta^{-}\rangle\,.\\
\end{align}
...
pavaizduota 5.4 pav. Grandinės pabaigoje įdėti klasiškai kontroliuojami
...
|\psi_{01}\rangle = & |0_x \rangle = \frac{1}{\sqrt{2}}\big(|0\rangle + |1\rangle\big)\,; \\
|\psi_{11}\rangle = & |1_x \rangle = \frac{1}{\sqrt{2}}\big(|0\rangle - |1\rangle\big)\,.
\end{align}
...
Panagrinėkime BB84 protokolo (žr. 5.5 pav.) saugumą. Pirmiausia,
...
\begin{align}
cX|\psi_{00}\rangle = & |00\rangle\,; \\
cX|\psi_{10}\rangle = & |11\rangle\,; \\
cX|\psi_{01}\rangle = & \frac{1}{\sqrt{2}}\big(|00\rangle + |11\rangle\big)\,; \\
cX|\psi_{11}\rangle = & \frac{1}{\sqrt{2}}\big(|00\rangle - |11\rangle\big)\,.
\end{align}
...
EPR protokolas (žr. 5.6 pav.) yra dauguma aspektų panašus į BB84, tačiau
...
$|\chi^{+}\rangle$ būsenoje:
\begin{align}
(X\otimes I)|\chi^{+}\rangle = &            |\eta^{+}\rangle\,; \\
(Y\otimes I)|\chi^{+}\rangle = & -\mathrm{i}|\eta^{-}\rangle\,; \\
(Z\otimes I)|\chi^{+}\rangle = &            |\chi^{-}\rangle\,.
\end{align}
...
+ |1\rangle\otimes |0\rangle\big\rbrack\,.
\end{align}
...
arba $\beta_2$. 5.7 pav. iliustruojame dvi tokias detektorių
konfigūracijas, pasuktas kampu $\alpha$ ir $\beta$:

![](./media/image5_7.png)

**5.7 pav.** Koordinačių sistemos pasukimas kampais $\alpha$ ir $\beta$
pradinės koordinačių sistemos atžvilgiu.
Pradinė koordinačių sistema apibrėžia horizontaliosios ir vertikaliosios poliarizacijos kryptis
...
lengvai randamos:
\begin{align}
|V^{\alpha}\rangle = &  \cos(\alpha)|V\rangle + \sin(\alpha)|H\rangle\,; \\
|H^{\alpha}\rangle = & -\sin(\alpha)|V\rangle + \cos(\alpha)|H\rangle\,.
\end{align}
