...
skirtingose lokacijose, tačiau identiškose sūkinio būsenose, sukeitus
...
```{r kvantine-teleportacija, echo=FALSE, fig.cap="Kvantinė $k_1$ kubito būsenos $|\\psi\\rangle$ teleportacija į $k_3$ kubitą", out.width='65%', fig.align='center'}
knitr::include_graphics("media/image5_1.svg")
```
...
Teleportacijoje pagrindinį vaidmenį atlieka supintoji kubitų pora, kurią
...
```{r kvantinio-supynimo-sukeitimas, echo=FALSE, fig.cap="Kvantinio supynimo sukeitimo protokolo iliustracija", out.width='55%', fig.align='center'}
knitr::include_graphics("media/image5_3.svg")
```
...
```{r kvantinio-supynimo-sukeitimas-2, echo=FALSE, fig.cap="Kvantinio supynimo sukeitimo realizacija loginėje grandinėje", out.width='86%', fig.align='center'}
knitr::include_graphics("media/image5_4.svg")
```
...
4 skyriuje, norint atlikti Pauli-$X$ projekcinį matavimą tereikia
atlikti gautiems kubitams Hadamardo transformaciją ir toliau jiems
...
```{r bb84-iliustracija, echo=FALSE, fig.cap="BB84 protokolo iliustracija", out.width='65%', fig.align='center'}
knitr::include_graphics("media/image5_5.svg")
```
...
= & \frac{1}{\2}\Big\lbrack\big(|0\rangle + |1\rangle\big)\otimes |0\rangle
+ \big(|0\rangle - |1\rangle\big)\otimes |1\rangle\Big\rbrack \\
= & \frac{1}{\2}\Big\lbrack |0\rangle\otimes\big(|0\rangle + |1\rangle)
...
```{r epr-rakto-iliustracija, echo=FALSE, fig.cap="EPR protokolo iliustracija", out.width='65%', fig.align='center'}
knitr::include_graphics("media/image5_6.svg")
```
...
palikus EPR šaltinį, tada galime apskaičiuoti **būsenų tikslumą**
(angl. *state fidelity*) palygindami sugeneruotą 2-kubitų būseną su grynąja
...
taikomi praktikoje siekiant patikrinti, ar sugeneruotos 2 kubitų būsenos
...
stadijoje nedarome jokių prielaidų, kokios tai sistemos ir kokiais
...
priklausomai nuo rastų $A_1$ ir $A_2$ verčių, $C$ gali būti tik +2 arba
...
CHSH nelygybė buvo išvesta atsižvelgiant į sistemos savybių paruošimo metodą ir jų matavimo konfigūraciją. Savybės paruošimas veda prie pirmosios prielaidos, vadinamos **realizmu**
(angl. *realism*). Realizmas įvardija, kad sistemos savybės yra tiksliai
apibrėžtos ir egzistuoja nepriklausomai nuo to, ar jos yra stebimos, ar
ne. Tai matome iš to, kad visos keturios savybės
...
jos būsenai. Dėl įvardinto didelio atstumo
tarp Agnės ir Beno lokacijų, kuriose jiedu atlieka sistemos savybių
matavimus, jų rasti rezultatai neturėtų akimirksniu paveikti vienas kito. Antraip,
...
```{r pasukti-detektoriai, echo=FALSE, fig.cap="Koordinačių sistemos pasukimas kampais $\\alpha$ ir $\\beta$ pradinės koordinačių sistemos atžvilgiu.  Pradinė koordinačių sistema apibrėžia horizontaliosios ir vertikaliosios poliarizacijos kryptis", out.width='37%', fig.align='center'}
knitr::include_graphics("media/image5_7.svg")
```
